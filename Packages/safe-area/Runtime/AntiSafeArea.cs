...
{
    [ExecuteAlways]
    public class AntiSafeArea : MonoBehaviour
    {
        public Variant variant;
        public Type_anti type_anti;
        ...
        Rect ModifySafeArea(Rect r)
        {
            ...
            //Debug.Log($"Top antiSafeArea    {Screen.height - r.yMax}");
            return r;
        }
