...
// TODO: 2. If a player hasn't logged into facebook after playing a level or two and want to invite friends, there's no indications or button requesting them to login in to invite friends...Only the invite friends button.
// TODO: 3. When I watched a few rewarded videos to get a free spin, nothing happened or prompted me to do anything next.
// TODO: Баг. YouWin page + Android back button
// TODO: Идея. Блокер "Лягушка". Невозможно разрушить. Раз в несколько ходов она съедает важную фишку (бомбу или ингредиент)
// TODO: Кнопка Claim. Что бы получить халявный спин, игрок должен войти в игру, зайти в колесо и нажать эту кнопку
// TODO: Сделать имплементации IScriptDefineSymbol для всех символов используемых в проекте
// TODO: Сделать более демократичную систему DRM
// TODO: Сделать попап выхода из приложения
